...
const DModels = [
  { id:1, n:"DeepSeek v3.2",     t:"Базовый",  i:0.25, o:0.4,  tp:"text", desc:"Open-source MoE-модель (671B параметров). Отлично справляется с кодом, математикой и агентными задачами при минимальной стоимости." },
  { id:2, n:"Grok 4.1 Fast",     t:"Базовый",  i:0.2,  o:0.5,  tp:"text", desc:"Быстрая модель от xAI с низким уровнем галлюцинаций. Подходит для брейнштормов, креативных задач и ежедневной переписки." },
  { id:3, n:"Claude Sonnet 4.6", t:"Премиум",  i:3.0,  o:15.0, tp:"text", desc:"Фронтирная модель Anthropic для кодинга и агентных задач (79.6% SWE-bench). Контекст до 1M токенов — идеальна для анализа документов, кода и аналитики." },
  { id:4, n:"GPT-5.2",           t:"Премиум",  i:1.75, o:14.0, tp:"text", desc:"Флагман OpenAI с тремя режимами работы и контекстом 400K. Сильна в аналитике, создании презентаций, работе с данными и написании кода." },
  { id:5, n:"Gemini 3 Pro",      t:"Премиум",  i:2.0,  o:12.0, tp:"text", desc:"Мультимодальная модель Google с контекстом 1M токенов. Работает с текстом, изображениями, аудио и видео — лучший выбор для сложного анализа." },
  { id:6, n:"Claude Opus 4.6",   t:"Ультра",   i:5.0,  o:25.0, tp:"text", desc:"Самая мощная модель Anthropic. Способна часами автономно работать над сложными задачами: глубокий анализ кодовых баз, исследования и стратегия." },
  { id:7, n:"Seedream 4.5",      t:"Дизайн",   i:0, o:0, tp:"image", p:0.04, desc:"Модель ByteDance для быстрой генерации в 2K/4K. Точное редактирование, отличная типографика и мультиязычный рендеринг текста." },
  { id:8, n:"Nano Banana Pro",   t:"Дизайн",   i:0, o:0, tp:"image", p:0.134, desc:"Модель Google на базе Gemini 3 Pro. Генерация до 4K с рендерингом текста, reasoning-функциями и поиском Google для создания точных изображений." },
  { id:9, n:"GPT Image 1.5",     t:"Дизайн",   i:0, o:0, tp:"image", p:0.04, desc:"Нативно мультимодальная модель OpenAI. Генерация до 4096×4096, точные правки с сохранением деталей и в 4 раза быстрее предшественника." },
];
